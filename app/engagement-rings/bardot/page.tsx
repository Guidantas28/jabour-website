...
const diamondShapes = [
  ...
  { id: 'pear', name: 'Pear', icon: '/images/diamonds/pear.png' },
  { id: 'heart', name: 'Heart', icon: '/images/diamonds/heart.png' },
  { id: 'cushion', name: 'Cushion', icon: '/images/diamonds/cushion.png' },
  { id: 'emerald', name: 'Emerald', icon: '/images/diamonds/emerald.png' },
  { id: 'asscher', name: 'Asscher', icon: '/images/diamonds/asscher.png' },
  { id: 'radiant', name: 'Radiant', icon: '/images/diamonds/radiant.png' },
  { id: 'princess', name: 'Princess', icon: '/images/diamonds/princess.png' },
]
...
// Function to get images based on shape and metal
const getImagesForShapeAndMetal = (shape?: string, metal?: string): string[] => {
  if (!shape || !metal) {
    // Default images if no shape or metal selected
    return [
      '/images/rings/bardot/bardot-round-platinum1.avif',
      '/images/rings/bardot/bardot-round-platinum2.avif',
      '/images/rings/bardot/bardot-round-platinum3.avif',
    ]
  }
  ...
  // Round + Platinum
  if (shapeLower === 'round' && metalLower === 'platinum') {
    return [
      '/images/rings/bardot/bardot-round-platinum1.avif',
      '/images/rings/bardot/bardot-round-platinum2.avif',
      '/images/rings/bardot/bardot-round-platinum3.avif',
  ...
  // Default to round platinum if combination not recognized
  return [
    '/images/rings/bardot/bardot-round-platinum1.avif',
    '/images/rings/bardot/bardot-round-platinum2.avif',
    '/images/rings/bardot/bardot-round-platinum3.avif',
...
function BardotContent() {
  ...
  const handleAddToCart = () => {
    ...
    const product = {
      id: `bardot-${selections.selectedDiamond}-${selections.metal}-${selections.bandStyle}-${selections.ringSize}`,
      name: 'Bardot Engagement Ring',
      price: totalPrice,
      image: getImagesForShapeAndMetal(selections.shape, selections.metal)[0],
  ...
  // Get images based on shape and metal
  const images = getImagesForShapeAndMetal(selections.shape, selections.metal)
  
  // Reset main image index when shape or metal changes
  useEffect(() => {
    setMainImageIndex(0)
  }, [selections.shape, selections.metal])
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="text-sm text-gray-700 mb-6 leading-relaxed">
              Available to buy as a lab-grown diamond or a natural diamond, the Bardot 18k gold diamond solitaire ring updates the classic style with sleek lines and refined proportions, designed to maximise the dispersion of light throughout the centre diamond. The minimalist form of the Bardot gives this simple solitaire engagement ring its enduring elegance and is an excellent alternative to our Bardot Scallop Engagement Ring in 18k Yellow Gold. This wedfit design is crafted to sit comfortably alongside a wedding ring and band.
            </p>
        ...
        <div id="diamond-selection-section" className="container-custom py-8 border-t border-gray-200 mt-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">
              Showing diamonds compatible with the Bardot engagement ring
            </p>
          </div>
...
export default function BardotPage() {
  return (
    <Suspense fallback={
